...
void main() {
  ...
  List<int> sortedList = radixSort(numbers: numbers);

  print('Sorted list: $sortedList');
}

List<int> radixSort({required List<int> numbers}) {
  ...
  void performRadixSort(List<int> arr, int n) {
    int m = getMax(arr, n);
